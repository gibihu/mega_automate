...
export function importOrder(set) {
    ...
    if(set.order_id !== null){
        ...
        cy.visit('/manage-order/sale/import-order/create?type=2');
        cy.url().should('include', '/manage-order/sale/import-order/create?type=2');
    }
