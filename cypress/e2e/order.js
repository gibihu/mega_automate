...
function step1(item) {
    ...
    cy.get('[name="customer_code"] > .MuiFormControl-root > .MuiInputBase-root').type(`${item.f1 !== null ? item.f1 : ''}{downarrow}{enter}`,{ scrollBehavior: 'center' });
    cy.get(':nth-child(7) > .MuiFormControl-root > .MuiInputBase-root > [name="note"]').type(item.f2 !== null ? item.f2 : 'ทดสอบอัตโนมัติ',{ scrollBehavior: 'center' });
...
function step2(item) {
    ...
    cy.get('[name="responsible_sales"] > .MuiFormControl-root > .MuiInputBase-root').type(`${item.f1 !== null ? item.f1 : ''}{downarrow}{enter}`,{ scrollBehavior: 'center' });
    cy.get('[name="responsible_purchase"] > .MuiFormControl-root > .MuiInputBase-root').click({ force: true });
    cy.get('[name="responsible_purchase"] > .MuiFormControl-root > .MuiInputBase-root').type(`${item.f2 !== null ? item.f2 : ''}{downarrow}{enter}`,{ scrollBehavior: 'center' });
    cy.get('[name="responsible_data_entry"] > .MuiFormControl-root > .MuiInputBase-root').click({ force: true })
    cy.get('[name="responsible_data_entry"] > .MuiFormControl-root > .MuiInputBase-root').type(`${item.f3 !== null ? item.f3 : ''}{downarrow}{enter}`,{ scrollBehavior: 'center' });
    cy.get('[name="responsible_accounting"] > .MuiFormControl-root > .MuiInputBase-root').click({ force: true })
    cy.get('[name="responsible_accounting"] > .MuiFormControl-root > .MuiInputBase-root').type(`${item.f4 !== null ? item.f4 : ''}{downarrow}{enter}`,{ scrollBehavior: 'center' });
...
function step3() {
    ...
    try{
        ...
        cy.get('[name="order_customer_contact_name"]').type(item.f1 !== null ? item.f1 : RandomName(),{ scrollBehavior: 'center' });

        cy.get('[name="insurance_amount"]').click({ scrollBehavior: 'center' })
        cy.get('[name="insurance_amount"]').type(item.f2 !== null ? item.f2 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        ...
        cy.log('⏹️ ช่องทางการสั่ง');
        cy.log('⏹️ ช่องทางที่ลูกค้าติดต่อ ');
        cy.wait(10000);
...
function step5(){
    try{
        ...
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(1)').click({ scrollBehavior: 'center', focus: true });
        cy.wait(5000);
        cy.get('[name="total_order_price"]').type(item.f1 !== null ? item.f1 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        cy.get('[name="total_company_cost"]').type(item.f2 !== null ? item.f2 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        cy.get('[name="discount_at_a"]').type(item.f3 !== null ? item.f3 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        cy.get('[name="discount_at_b"]').type(item.f4 !== null ? item.f4 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        cy.get('[name="total_customer_paid"]').type(item.f5 !== null ? item.f5 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        cy.get('[name="total_shipping_customer_paid"]').type(item.f6 !== null ? item.f6 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        cy.get('[name="total_product_company_paid"]').type(item.f7 !== null ? item.f7 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        cy.get('[name="total_shipping_company_paid"]').type(item.f8 !== null ? item.f8 : RandomNumbers(1)*100,{ scrollBehavior: 'center' });
        cy.get(':nth-child(10) > .MuiFormControl-root > .MuiInputBase-root > [name="note"]').type(item.f9 !== null ? item.f9 : RandomName(),{ scrollBehavior: 'center' });
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ อัปโหลดใบเสนอราคาเต็มรูปแบบ');
        cy.wait(15000);
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(2)').click({ scrollBehavior: 'center', focus: true });
    }catch{
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(1)').click({ scrollBehavior: 'center', focus: true });
...
function step6(){
    try{
        ...
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ อัปโหลดหลักฐานการชำระเงิน (ครั้งที่1) ');
        cy.log('⏹️ โกดังจีน (ที่จัดส่งสินค้าเข้า)');
        cy.wait(15000);
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(2)').click({ scrollBehavior: 'center', focus: true });
    }catch{
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(1)').click({ scrollBehavior: 'center', focus: true });
...
function step7(){
    try{
        ...
        cy.wait(5000);
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ อัปโหลดเอกสารพร้อมลายเซ็น 9 แบบ');
        cy.wait(15000);
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(2)').click({ scrollBehavior: 'center', focus: true });
    }catch{
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(1)').click({ scrollBehavior: 'center', focus: true });
...
function step8(){
    try{
        ...
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ อัปโหลดหลักฐานการสั่งซื้อ');
        cy.log('⏹️ อัปโหลดหลักฐานการสั่งซื้อ/จ่ายร้านค้าโรงงาน');
        cy.wait(20000);
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(2)').click({ scrollBehavior: 'center', focus: true });
    }catch{
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(1)').click({ scrollBehavior: 'center', focus: true });
...
function step9(){
    try{
        ...
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ อัปโหลดหลักฐานการจัดส่งขนส่งจีน ');
        cy.wait(15000);
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(2)').click({ scrollBehavior: 'center', focus: true });
    }catch{
        cy.get('.MuiPaper-root.Mui-expanded > .MuiCollapse-root > .MuiCollapse-wrapper > .MuiCollapse-wrapperInner > .MuiAccordion-region > .MuiAccordionActions-root > .MuiStack-root > :nth-child(1)').click({ scrollBehavior: 'center', focus: true });
...
function step10(){
    try{
        ...
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ รูปสินค้า/ใบ PO รับเข้า');
        cy.log('⏹️ อัปโหลดใบปะหน้าพัสดุ ');
        cy.log('⏹️ อัปโหลดหลักฐานการ QC');
        cy.log('⏹️ อัปโหลดหลักฐานการ QC');
        cy.wait(30000);
...
function step11(){
    try{
        ...
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ อัปโหลดรูปจัดส่งออกจากโกดังจีน');
        cy.wait(15000);
...
function step12(){
    try{
        ...
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ โกดังไทย');
        cy.log('⏹️ อัปโหลดใบแจ้งหนี้ขนส่ง');
        cy.log('⏹️ อัปโหลดหลักฐานการชำระเงินจีน - ไทย');
        cy.wait(30000);
...
function step13(){
    try{
        ...
        cy.log('👉 เพิ่มสิ่งที่ AUTOMATE กดไม่ได้');
        cy.log('⏹️ ชื่อขนส่งเอกชน');
        cy.log('⏹️ อัปโหลดหลักฐานการจัดส่งในไทย');
        cy.wait(20000);
